...
def createDirectories(PATH, tftr):
    ...
    createDir(f"{PATH}/{tftr}/input")
    createDir(f"{PATH}/{tftr}/output")
    ftr_map = []
    sub_input = os.listdir(f"{PATH}/input")
    for d in sub_input:
        createDir(f"{PATH}/{tftr}/input/{d}")
        ftr_map.append(  (f"{PATH}/input/{d}", f"{PATH}/{tftr}/input/{d}")  )
    sub_input = os.listdir(f"{PATH}/output")
    for d in sub_input:
        createDir(f"{PATH}/{tftr}/output/{d}")
        ftr_map.append(  (f"{PATH}/output/{d}", f"{PATH}/{tftr}/output/{d}")  )
    return ftr_map
